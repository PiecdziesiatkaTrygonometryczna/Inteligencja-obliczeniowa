...
def main():
    ...
    model = load_model('model/model3.keras', compile=False) # insert name of a model
    ...
    dirs = [] # insert directories to predict animals from all .jpg images from that directories
    for dir in dirs:
